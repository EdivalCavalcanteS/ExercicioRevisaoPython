print ("Bom dia! Veio por nossas ótimas promoções certo?")

TipoDaCarne = str(input("Qual carne vai querer hoje? File duplo?, Alcatra? ou Picanha?"))

Quantidade = int(input("Aah quase me esqueci._., digame quanto kilos vai querer? (Obs;só vendemos por kilo e não kilo(s) e meio:("))
